...
I did my own baby-steps in frontend development around this time, during my bachelor in Digital Media and Design, but I had no idea about these frameworks. Looking back, it's actually somewhat funny: one of our first courses was about frontend development, and one of the deliverables over the course was a Wordpress-based blog, we had to set up ourselves. Honestly it never really caught on with me, and beyond making very simple HTML and CSS changes, I don't think I even ended up writing more than 10 lines of PHP. I wasn't really interested or motivated and would not have called myself a developer at the time. That's a different story though.

- Made very famous by React
- Other flavours, e.g. Knockout JS
