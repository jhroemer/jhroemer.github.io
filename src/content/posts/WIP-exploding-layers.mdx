...
I was trying to implement and configure his glowing cards, when I realized how much is going on in that demo.
...
I won't go into detail here, you can read the other post for that, but essentially we have two or more elements that are layered in order to get a complex border effect.
...
Add a bit of delay to the transforms to make them apply in steps.
